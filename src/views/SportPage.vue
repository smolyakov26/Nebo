...
useSeoMeta({
  title: 'Спортивные прыжки с парашютом Ессентуки — от 2 000 ₽ | НЕБО КАВКАЗА',
  description:
    'Спортивные прыжки с парашютом в Ессентуках для лицензированных парашютистов. Высота 1200-3000м, самолёт АН-2. Цена от 2 000 ₽.',
  ogTitle: 'Спортивные прыжки с парашютом Ессентуки — от 2 000 ₽',
  ogDescription:
    'Самостоятельные прыжки для лицензированных парашютистов. Аэродром Ессентуки, от 2 000 ₽.',
