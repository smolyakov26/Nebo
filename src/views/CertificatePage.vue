...
useSeoMeta({
  title: 'Подарочный сертификат на прыжок с парашютом Ессентуки | НЕБО КАВКАЗА',
  description:
    'Подарочный сертификат на прыжок с парашютом в Ессентуках — идеальный подарок. Тандем от 17 000 ₽, соло от 7 500 ₽. Электронный или печатный формат.',
  ogTitle: 'Подарочный сертификат на прыжок с парашютом Ессентуки',
  ogDescription:
    'Идеальный подарок в Ессентуках: тандем 17 000 ₽, соло от 7 500 ₽. Электронный или печатный.',
