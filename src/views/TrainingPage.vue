...
useSeoMeta({
  title: 'Обучение парашютизму Ессентуки — курс ДОСААФ от 30 000 ₽ | НЕБО КАВКАЗА',
  description:
    'Обучение парашютизму в Ессентуках. Программа ДОСААФ №2 — базовая подготовка парашютиста. 10 часов теории, практические прыжки. Группы до 6 человек.',
  ogTitle: 'Обучение парашютизму Ессентуки — от 30 000 ₽',
  ogDescription:
    'Курс ДОСААФ №2 в Ессентуках. 10 часов теории + практические прыжки. Группы до 6 человек.',
