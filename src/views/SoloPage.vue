...
useSeoMeta({
  title: 'Прыжок с парашютом Ессентуки — самостоятельный прыжок от 7 500 ₽ | НЕБО КАВКАЗА',
  description:
    'Самостоятельный прыжок с парашютом в Ессентуках по программе ДОСААФ. Цена от 7 500 ₽. Круглый парашют Д-10, высота 800м. С 16 лет.',
  ogTitle: 'Самостоятельный прыжок с парашютом Ессентуки — от 7 500 ₽',
  ogDescription:
    'Первый самостоятельный прыжок по программе ДОСААФ в Ессентуках. С 16 лет, 7 500 ₽.',
    ...
    <main>
      <section ref="elementRef" class="pt-40 pb-24 relative overflow-hidden">
        <div class="absolute inset-0 z-0 opacity-30">
          <picture>
            <source srcset="/images-optimized/home/solo_main.webp" type="image/webp" />
            <img
              src="/images-optimized/home/solo_main.jpg"
              alt="Соло прыжок"
