...
export const FOOTER = {
  ...
  contacts: [
    { label: 'Адрес', value: SHARED.address, icon: 'MapPin' },
    { label: 'Телефон', value: SHARED.phone, href: SHARED.phoneHref, icon: 'Phone' },
    { label: 'Email', value: SHARED.email, href: SHARED.emailHref, icon: 'Mail' },
    { label: 'Режим', value: 'Ср — Вс, 09:00 — 18:00', icon: 'Clock' },
  ],
...
export const HERO = {
  ...
  description:
    'Почувствуйте абсолютную свободу в свободном падении. Мы создаем моменты, которые меняют жизнь навсегда.',
...
export const CERTIFICATE_MODAL = {
