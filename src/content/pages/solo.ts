export const soloContent = {
  ...
  description: 'По программе ДОСААФ №1-2. Прыжок с круглым парашютом Д-1-5у с высоты 800 метров. Принудительное раскрытие ранца. Отделение «Солдатиком» — и вы летите!',
  price: 'от 5 000 ₽',
  ...
  programSteps: [
    {
      step: '1',
      title: 'Теория',
      description: '3 часа наземной подготовки: история парашютизма, основы прыжка, конструкция парашюта, правила безопасности.'
    },
    {
      step: '2',
      title: 'Наземная отработка',
      description: '1 час на тренажёрах. Отработка положения «Солдатик», действий при раскрытии парашюта, приземления.'
    },
    {
      step: '3',
      title: 'Прыжок',
      description: 'Прыжок с принудительным раскрытием. Отделение «Солдатиком», управление куполом, приземление.'
    },
    {
      step: '4',
      title: 'Анализ',
